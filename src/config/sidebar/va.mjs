...
export const sidebarVA =[
  { label: 'VA 律藏导读', link: '/vinaya/' },
  {
    ...
    items:[
      ...
      },
      {
        ...
        items:[
          { label: 'BV 2.1 僧残一：故意泄精学处 (Sukkavissaṭṭhi)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-01-sukkavissatthi/' },
          { label: 'BV 2.2 僧残二：身体接触学处 (Kāyasaṃsagga)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-02-kayasamsagga/' },
          { label: 'BV 2.3 僧残三：粗恶语学处 (Duṭṭhullavācā)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-03-dutthullavaca/' },
          { label: 'BV 2.4 僧残四：为己求淫欲供养学处 (Attakāmapāricariya)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-04-attakamaparicariya/' },
          { label: 'BV 2.5 僧残五：作媒学处 (Sañcaritta)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-05-sancaritta/' },
          { label: 'BV 2.6 僧残六：造房舍学处 (Kuṭikāra)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-06-kutikara/' },
          { label: 'BV 2.7 僧残七：建造精舍学处 (Vihārakāra)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-07-viharakara/' },
          { label: 'BV 2.8 僧残八：恶意诽谤学处 (Duṭṭhadosa)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-08-dutthadosa/' },
          { label: 'BV 2.9 僧残九：第二恶意诽谤学处 (Dutiyaduṭṭhadosa)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-09-dutiyadutthadosa/' },
          { label: 'BV 2.10 僧残十：破僧学处 (Saṃghabheda)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-10-sanghabheda/' },
          { label: 'BV 2.11 僧残十一：助破僧学处 (Bhedānuvattaka)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-11-bhedanuvattaka/' },
          { label: 'BV 2.12 僧残十二：恶语学处 (Dubbaca)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-12-dubbaca/' },
          { label: 'BV 2.13 僧残十三：污家学处 (Kuladūsaka)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-13-kuladusaka/' },
        ]
      },
      { label: 'BV 3 不定篇 (Aniyatakaṇḍa)', link: '/vinaya/bv/kanda-03-aniyata/' },
      {
        ...
        collapsed: true,
        items:[
          { label: 'BV 4.1 衣品 (Cīvaravagga)', link: '/vinaya/bv/kanda-04-nissaggiya/bv-04-01-civara/' },
          { label: 'BV 4.2 俱舍耶品 (Kosiyavagga)', link: '/vinaya/bv/kanda-04-nissaggiya/bv-04-02-kosiya/' },
          { label: 'BV 4.3 钵品 (Pattavagga)', link: '/vinaya/bv/kanda-04-nissaggiya/bv-04-03-patta/' },
        ]
      },
      {
  ...
  },
  {
    ...
    items:[
      ...
      { label: 'PV 4 中间诵文 (Antarapeyyāla)', link: '/vinaya/pv/pv-04-antarapeyyala/' },
      ...
      { label: 'PV 17 优波离五法集 (Upālipañcaka)', link: '/vinaya/pv/pv-17-upalipancaka/' },
