    ...
    items:[
      ...
      },
      {
        ...
        items:[
          ...
          { label: 'BV 2.6 僧残六：自造精舍 (Kuṭikāra)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-06-kutikara/' },
          { label: 'BV 2.7 僧残七：恶意诽谤 (Vihārakāra)', link: '/vinaya/bv/kanda-02-sanghadisesa/bv-02-07-viharakara/' },
