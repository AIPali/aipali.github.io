...
> [!abstract] AI 导读
> 本篇详细记述了“布萨 (Uposatha)”制度的制定过程。布萨是佛教僧团一项至关重要的共住仪式，通常每半月（农历的十五日和月底日）举行一次。故事始于频毗娑罗王的建议，他看到外道在特定日子集会说法，信众云集，便建议佛陀的僧团也仿效。佛陀采纳了建议，并逐步完善了这一制度：从最初的默然静坐，发展到说法，最终确立了以诵念《波罗提木叉》（比丘戒条）为核心的布萨仪式。
> 
